# tier2-release-products Specification

## Purpose
Define complete Tier 2 partner releases and Aggregate 2 products that use exact reviewed publications, preserve partner provenance, and prevent ambiguous canonical identity output.
## Requirements
