# invitation-only-account-provisioning Specification

## Purpose
Define the invitation-only workspace account lifecycle, including administrator
provisioning, invite delivery and resend, password setup, and the rejection of
