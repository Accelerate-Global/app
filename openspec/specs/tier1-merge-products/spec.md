# tier1-merge-products Specification

## Purpose
Define deterministic Tier 1 merge products that select values by approved source priority while retaining field-level provenance, conflicts, and exact input lineage.
## Requirements
