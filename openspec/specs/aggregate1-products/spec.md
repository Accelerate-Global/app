# aggregate1-products Specification

## Purpose
Define reproducible Aggregate 1 products that group exact Tier 1 publications, apply approved calculations, and preserve the lineage needed to review every result.
## Requirements
