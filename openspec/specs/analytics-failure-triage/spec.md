# analytics-failure-triage Specification

## Purpose
Define how the admin analytics page groups failed analytics events, separates
expected and resolved outcomes from actionable failures, and persists triage
state for follow-up.
