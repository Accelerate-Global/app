...
## Purpose
Define the public repository's reporting, scanning, release enforcement,
artifact-retention, historical-repository retirement, and merged-ref cleanup
controls.
## Requirements
...
vulnerability reporting, CodeQL default setup, SHA-pinned Actions enforcement,
and strict required checks on `main`. Administrators MUST be subject to the
required checks and force-push or deletion protection.
