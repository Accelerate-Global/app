...
The system SHALL finalize each forming attempt as a valid, invalid, or failed inspectable candidate with deterministic counts, summaries, complete private artifacts, and output checksum.
