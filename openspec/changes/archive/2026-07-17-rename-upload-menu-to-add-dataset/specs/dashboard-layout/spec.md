...
The system SHALL keep the authenticated dashboard frame stable, provide immediate visual feedback while dashboard route content loads, and label the administrator dataset-creation menu entry `Add Dataset`.
