...
- Promote curated dataset grain, field definitions, aliases, types, units, null semantics, allowed-value/resolver policy, metric formulas, relationship/dependency metadata, source lineage/freshness, pipeline/filter definitions, and reference-resource summaries into a checksum-bound semantic-context snapshot after conflict review.
