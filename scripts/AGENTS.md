...
- `/Users/blake/Documents/accelerate-global/online/scripts/ship.ts` must wait for `App Quality`, `OpenSpec`, `UI Smoke`, `Database Security`, and `Dependency Audit` before merge.
