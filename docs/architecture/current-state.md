...
- The retired private-model chat page, APIs, analytics projection, semantic
  catalog, and edge relay are not part of the current application. Dataset
  filtering and the standalone Country/ROG and ROP resource surfaces remain
  application-owned and do not depend on a model runtime.
